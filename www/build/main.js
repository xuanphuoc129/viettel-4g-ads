...
var FakeCustomerComponent = /** @class */ (function () {
    ...
    FakeCustomerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'fake-customer',template:/*ion-inline-start:"/Users/admin/workspace/ionic/viettel-4g-ads/src/components/fake-customer/fake-customer.html"*/'<!-- Generated template for the FakeCustomerComponent component -->\n<div>\n  <div #fakeCustomer class="a3-container a3-items-center animated slideInLeft" id="fakeId">\n    <div class="icon-image">\n      <img src="./assets/imgs/fake-customer.png" alt="Viettel CA">\n    </div>\n\n    <div class="text-show">\n      <div class="success-text"><strong>Đăng ký thành công</strong></div>\n      <div>Khách hàng <strong>{{customer.name}}</strong> ở <strong>{{customer.address}}</strong> vừa đăng ký thành công</div>\n    </div>\n  </div>\n</div>\n'/*ion-inline-end:"/Users/admin/workspace/ionic/viettel-4g-ads/src/components/fake-customer/fake-customer.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    function HomePage(mEvent, mMenuController, mDectectChange, mAppModule, navCtrl) {
        ...
        this.menuIcon = "menu";
        this.mPackages = [];
        this.mColors = ["primary-color", "orange-color", "blue-color"];
        this.mColors2 = ["primary", "orange", "blue"];
        this.mScrollTop = 0;
